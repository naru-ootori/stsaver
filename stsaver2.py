...
class MainWindow(QMainWindow):
    ...
    def initUI(self):
        ...
        self.qle_start.setGeometry(45, 131, 50, 25)
        self.qle_start.setInputMask('99:99:99')
        self.qle_start.setText('00:00:00')
        ...
        self.qle_end.setGeometry (125, 131, 50, 25)
        self.qle_end.setInputMask('99:99:99')
        self.qle_end.setText('00:00:00')
    ...
    def runffmpeg(self):
        ...
        t1         = datetime.datetime.strptime(start, '%H:%M:%S')
        t2         = datetime.datetime.strptime(end, '%H:%M:%S')
        ...
        self.stamp = pure_name + '-' + t1.strftime('%H%M%S') + '-' + t2.strftime('%H%M%S')
